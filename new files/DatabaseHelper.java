package com.lastfmdatabase.loginregister.sql;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "UserManagers.db";
    ...
    private String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "("
            ...
            + COLUMN_USER_EMAIL + " TEXT," +  COLUMN_USER_COUNTRY + " TEXT," + COLUMN_USER_PASSWORD + " TEXT" + ")";
    ...
    /**
     * This method fetches all users and returns the list of user records
     */
    ...
    public String getCountry(String email){
        ...
        if(cursor!=null && cursor.moveToFirst()) country = cursor.getString(0);
        db.close();
